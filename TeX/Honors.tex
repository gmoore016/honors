...
\begin{document}
	...
	\begin{align*}
	debt_i = \delta_0 &+ \delta_1 atCap + \delta_2 policyImpact + \delta_3 need + \delta_4 atCap \times policyImpact \\
	 &+ \delta_5 atCap \times need + \delta_6 policyImpact \times need + \delta_7 atCap \times policyImpact \times need \\
	...
	\begin{table}
		...
		\begin{tabular}{lp{8cm}}
			...
			\midrule
			$\delta_1$ & Impact of having need greater than \$4,500 \\
			$\delta_2$ & The impact of an additional dollar of credit line availability for those below the cap (expected to be zero)\\
			$\delta_3$ & The impact of an additional dollar of need\\
			$\delta_4$ & The impact of an additional dollar of credit for those at the cap, not considering degree of need\\
			$\delta_5$ & The impact of an additional dollar of demonstrated need after the first \$4,500 of need\\
			$\delta_6$ & The impact of an additional dollar of credit availability for those not at the cap (expected to be zero)\\
	...
	\begin{table}
		...
		\input{\regs stage2.tex}
		\caption{Second stage results}
		\label{stage2}
	\end{table}
	
	The results of these regressions are visible in table \ref{stage2}.
	...
	\begin{table}
		\centering
		\scriptsize
		\input{\regs stage2full.tex}
		
		\caption{Table \ref{stage2} full results}
	\end{table}
